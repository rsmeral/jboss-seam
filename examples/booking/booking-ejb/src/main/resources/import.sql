insert into Customer (username, password, name) values ('demo1', 'demodemo', 'Demo One')
insert into Customer (username, password, name) values ('demo2', 'demodemo', 'Demo Two')
insert into Customer (username, password, name) values ('demo3', 'demodemo', 'Demo Three')
insert into Customer (username, password, name) values ('demo4', 'demodemo', 'Demo Four')
