insert into Customer (username, password, name) values ('demo1', 'demo', 'Demo One')
insert into Customer (username, password, name) values ('demo2', 'demo', 'Demo Two')
insert into Customer (username, password, name) values ('demo3', 'demo', 'Demo Three')
insert into Customer (username, password, name) values ('demo4', 'demo', 'Demo Four')
